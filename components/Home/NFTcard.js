...
const style = {
  wrapper: `relative flex h-[400px] w-[280px] cursor-pointer flex-col rounded-lg bg-white shadow-lg transition-all duration-300 hover:shadow-2xl dark:bg-[#333333]`,
